...
#define STRING_CONFIG_H_AUTHOR "(reloxx13)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Ender-3 SKR Mini E3 v2026.4"
...
#define EXTRUDE_MAXLENGTH 600 // Ender-3 Bowden path allows long load / unload moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -27, -2, -1.70 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
