...
#define STRING_CONFIG_H_AUTHOR "(ReloxX)" // Who made the changes.
//#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "(Ender 3)"         // will be shown during bootup in line 2
...
#define EXTRUDE_MAXLENGTH 500 //ender3 bowden 410mm
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 8000, 8000, 100, 100 }
...
// arms https://www.thingiverse.com/thing:3432489
#define X_PROBE_OFFSET_FROM_EXTRUDER -27  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -2 //sanity has to be integer, real are -1.70  // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.14   // Z offset: -below +above  [the nozzle]
...
#define Z_MAX_POS 250 - 5 //-5 tool holder/bowden
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 57
  #define Z_SAFE_HOMING_Y_POINT 31.7
#endif
...
#define PREHEAT_1_TEMP_HOTEND 160 //heat but dont let filament oouze
